...
const callbackFunction = ()=> console.log('we`re using node modules yeah!!');

greet('johnny', 'rambo', callbackFunction);

greet('johnny', 'rambo', ()=> console.log('we`re using node modules yeah!!'));
